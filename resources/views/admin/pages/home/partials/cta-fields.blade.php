{{--
    Reusable CTA field group for the Home editor.
    Expects: $ctaData (array), $fieldName (e.g. "content[primary_cta]"),
    $errorKey (e.g. "content.primary_cta"), $heading, $allowedRoutes,
    $allowedAnchors (config('cms-links.anchors') — group => list of anchors).
--}}
@php
    $ctaData = $ctaData ?? [];
